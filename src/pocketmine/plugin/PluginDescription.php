...
/*
 * NOTE: This file has been modified to allow extending. Mainly private -> protected
 */
...
class PluginDescription{
	...
	protected $order = PluginLoadOrder::POSTWORLD;
	 ...
	 */
	protected function loadMap(array $plugin){
